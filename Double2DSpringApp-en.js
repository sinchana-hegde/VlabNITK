...
mpl$lab$util$Util.COMPILE_TIME = "2019-05-12 11:35:50";
...
var mpl$lab$view$DisplayLine = function(a, b) {
    this.line_ = goog.isDefAndNotNull(a) ? a : new mpl$lab$model$ConcreteLine("proto");
    this.proto_ = goog.isDefAndNotNull(b) ? b : null
};
mpl$lab$view$DisplayLine.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", thickness: " + mpl$lab$util$Util.NF(this.getThickness()) + ', color: "' + this.getColor() + '", lineDash: [' + this.getLineDash() + "], zIndex: " + this.getZIndex() + ", proto: " + (null != this.proto_ ? this.proto_.toStringShort() : "null") + "}"
}
;
mpl$lab$view$DisplayLine.prototype.toStringShort = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : "DisplayLine{line_: " + this.line_.toStringShort() + "}"
}
;
mpl$lab$view$DisplayLine.prototype.contains = function(a) {
    return !1
}
;
mpl$lab$view$DisplayLine.prototype.draw = function(a, b) {
    if (0 < this.getThickness()) {
        var c = b.simToScreen(this.line_.getStartPoint());
        b = b.simToScreen(this.line_.getEndPoint());
        if (!(1E-6 > c.distanceTo(b))) {
            a.save();
            var d = this.getLineDash();
            0 < d.length && a.setLineDash && a.setLineDash(d);
            a.lineWidth = this.getThickness();
            a.strokeStyle = this.getColor();
            a.beginPath();
            a.moveTo(c.getX(), c.getY());
            a.lineTo(b.getX(), b.getY());
            a.stroke();
            a.restore()
        }
    }
...
;
mpl$lab$view$DisplayLine.prototype.getColor = function() {
    return void 0 !== this.color_ ? this.color_ : null != this.proto_ ? this.proto_.getColor() : "gray"
}
;
mpl$lab$view$DisplayLine.prototype.getLineDash = function() {
    return void 0 !== this.lineDash_ ? this.lineDash_ : null != this.proto_ ? this.proto_.getLineDash() : []
}
;
mpl$lab$view$DisplayLine.prototype.getMassObjects = function() {
    return []
}
;
mpl$lab$view$DisplayLine.prototype.getPosition = function() {
    return this.line_.getStartPoint().add(this.line_.getEndPoint()).multiply(.5)
}
;
mpl$lab$view$DisplayLine.prototype.getSimObjects = function() {
    return [this.line_]
}
;
mpl$lab$view$DisplayLine.prototype.getThickness = function() {
    return void 0 !== this.thickness_ ? this.thickness_ : null != this.proto_ ? this.proto_.getThickness() : 4
}
;
mpl$lab$view$DisplayLine.prototype.getZIndex = function() {
    return void 0 !== this.zIndex_ ? this.zIndex_ : null != this.proto_ ? this.proto_.getZIndex() : 0
}
;
mpl$lab$view$DisplayLine.prototype.isDragable = function() {
    return !1
}
;
mpl$lab$view$DisplayLine.prototype.setColor = function(a) {
    this.color_ = a;
    return this
}
;
mpl$lab$view$DisplayLine.prototype.setDragable = function(a) {}
;
mpl$lab$view$DisplayLine.prototype.setLineDash = function(a) {
    this.lineDash_ = a;
    return this
}
;
mpl$lab$view$DisplayLine.prototype.setPosition = function(a) {}
;
mpl$lab$view$DisplayLine.prototype.setThickness = function(a) {
    this.thickness_ = a;
    return this
}
;
mpl$lab$view$DisplayLine.prototype.setZIndex = function(a) {
    this.zIndex_ = a
}
;
...
;
var mpl$sims$springs$Double2DSpringSim = function(a) {
    mpl$lab$model$AbstractODESim.call(this, a);
    this.setVarsList(new mpl$lab$model$VarsList([mpl$sims$springs$Double2DSpringSim.en.X_POSITION + "-1", mpl$sims$springs$Double2DSpringSim.en.Y_POSITION + "-1", mpl$sims$springs$Double2DSpringSim.en.X_POSITION + "-2", mpl$sims$springs$Double2DSpringSim.en.Y_POSITION + "-2", mpl$sims$springs$Double2DSpringSim.en.X_VELOCITY + "-1", mpl$sims$springs$Double2DSpringSim.en.Y_VELOCITY + "-1", mpl$sims$springs$Double2DSpringSim.en.X_VELOCITY + "-2", mpl$sims$springs$Double2DSpringSim.en.Y_VELOCITY + "-2", mpl$lab$model$EnergySystem.en.KINETIC_ENERGY, mpl$lab$model$EnergySystem.en.POTENTIAL_ENERGY, mpl$lab$model$EnergySystem.en.TOTAL_ENERGY, mpl$lab$model$VarsList.en.TIME, mpl$sims$springs$Double2DSpringSim.en.ANCHOR_X, mpl$sims$springs$Double2DSpringSim.en.ANCHOR_Y],[mpl$sims$springs$Double2DSpringSim.i18n.X_POSITION + "-1", mpl$sims$springs$Double2DSpringSim.i18n.Y_POSITION + "-1", mpl$sims$springs$Double2DSpringSim.i18n.X_POSITION + "-2", mpl$sims$springs$Double2DSpringSim.i18n.Y_POSITION + "-2", mpl$sims$springs$Double2DSpringSim.i18n.X_VELOCITY + "-1", mpl$sims$springs$Double2DSpringSim.i18n.Y_VELOCITY + "-1", mpl$sims$springs$Double2DSpringSim.i18n.X_VELOCITY + "-2", mpl$sims$springs$Double2DSpringSim.i18n.Y_VELOCITY + "-2", mpl$lab$model$EnergySystem.i18n.KINETIC_ENERGY, mpl$lab$model$EnergySystem.i18n.POTENTIAL_ENERGY, mpl$lab$model$EnergySystem.i18n.TOTAL_ENERGY, mpl$lab$model$VarsList.i18n.TIME, mpl$sims$springs$Double2DSpringSim.i18n.ANCHOR_X, mpl$sims$springs$Double2DSpringSim.i18n.ANCHOR_Y],this.getName() + "_VARS"));
    this.getVarsList().setComputed(8, 9, 10);
    this.dragBlock_ = -1;
    this.gravity_ = 9.8;
    this.potentialOffset_ = this.damping_ = 0;
    this.topMass_ = mpl$lab$model$PointMass.makeSquare(.5, "top");
    this.topMass_.setPosition(new mpl$lab$util$Vector(0,2));
    this.bob1_ = mpl$lab$model$PointMass.makeCircle(.5, "bob1").setMass(.5);
    this.bob2_ = mpl$lab$model$PointMass.makeCircle(.5, "bob2").setMass(.5);
    this.spring1_ = new mpl$lab$model$Spring("spring1",this.topMass_,mpl$lab$util$Vector.ORIGIN,this.bob1_,mpl$lab$util$Vector.ORIGIN,1,6);
    this.spring2_ = new mpl$lab$model$Spring("spring2",this.bob1_,mpl$lab$util$Vector.ORIGIN,this.bob2_,mpl$lab$util$Vector.ORIGIN,1,6);
    this.springs_ = [this.spring1_, this.spring2_];
    this.restState();
    this.getSimList().add(this.topMass_, this.bob1_, this.bob2_, this.spring1_, this.spring2_);
    a = this.getVarsList().getValues();
    a[0] += .5;
    a[1] -= .5;
    this.getVarsList().setValues(a);
    this.saveInitialState();
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$Double2DSpringSim.en.GRAVITY,mpl$sims$springs$Double2DSpringSim.i18n.GRAVITY,goog.bind(this.getGravity, this),goog.bind(this.setGravity, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$Double2DSpringSim.en.DAMPING,mpl$sims$springs$Double2DSpringSim.i18n.DAMPING,goog.bind(this.getDamping, this),goog.bind(this.setDamping, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$Double2DSpringSim.en.LENGTH,mpl$sims$springs$Double2DSpringSim.i18n.LENGTH,goog.bind(this.getLength, this),goog.bind(this.setLength, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$Double2DSpringSim.en.MASS1,mpl$sims$springs$Double2DSpringSim.i18n.MASS1,goog.bind(this.getMass1, this),goog.bind(this.setMass1, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$Double2DSpringSim.en.MASS2,mpl$sims$springs$Double2DSpringSim.i18n.MASS2,goog.bind(this.getMass2, this),goog.bind(this.setMass2, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$Double2DSpringSim.en.STIFFNESS,mpl$sims$springs$Double2DSpringSim.i18n.STIFFNESS,goog.bind(this.getStiffness, this),goog.bind(this.setStiffness, this)))
};
$jscomp.inherits(mpl$sims$springs$Double2DSpringSim, mpl$lab$model$AbstractODESim);
mpl$sims$springs$Double2DSpringSim.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", gravity_: " + mpl$lab$util$Util.NF(this.gravity_) + ", damping_: " + mpl$lab$util$Util.NF(this.damping_) + ", bob1_: " + this.bob1_ + ", bob2_: " + this.bob2_ + ", spring1_: " + this.spring1_ + ", spring2_: " + this.spring2_ + ", topMass_: " + this.topMass_ + mpl$lab$model$AbstractODESim.prototype.toString.call(this)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getClassName = function() {
    return "Double2DSpringSim"
}
;
mpl$sims$springs$Double2DSpringSim.prototype.restState = function() {
    var a = this.bob1_.getMass()
      , b = this.bob2_.getMass()
      , c = this.spring1_.getStiffness()
      , d = this.spring2_.getStiffness()
      , e = this.spring1_.getRestLength()
      , f = this.spring2_.getRestLength()
      , g = this.topMass_.getPosition().getY()
      , h = this.getVarsList().getValues();
    h[13] = g;
    h[0] = h[2] = h[12] = this.topMass_.getPosition().getX();
    h[1] = g - this.gravity_ * (a + b) / c - e;
    h[3] = g - this.gravity_ * (b / d + (a + b) / c) - e - f;
    h[4] = h[5] = h[6] = h[7] = 0;
    this.getVarsList().setValues(h);
    this.moveObjects(h);
    this.setPotentialEnergy(0)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getEnergyInfo = function() {
    var a = this.getVarsList().getValues();
    this.moveObjects(a);
    return this.getEnergyInfo_(a)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getEnergyInfo_ = function(a) {
    a = this.bob1_.getKineticEnergy() + this.bob2_.getKineticEnergy();
    var b = this.gravity_ * this.bob1_.getMass() * this.bob1_.getPosition().getY();
    b += this.gravity_ * this.bob2_.getMass() * this.bob2_.getPosition().getY();
    b += this.spring1_.getPotentialEnergy();
    b += this.spring2_.getPotentialEnergy();
    return new mpl$lab$model$EnergyInfo(b + this.potentialOffset_,a)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setPotentialEnergy = function(a) {
    this.potentialOffset_ = 0;
    this.potentialOffset_ = a - this.getEnergyInfo().getPotential()
}
;
mpl$sims$springs$Double2DSpringSim.prototype.modifyObjects = function() {
    var a = this.getVarsList()
      , b = a.getValues();
    this.moveObjects(b);
    b = this.getEnergyInfo_(b);
    a.setValue(8, b.getTranslational(), !0);
    a.setValue(9, b.getPotential(), !0);
    a.setValue(10, b.getTotalEnergy(), !0)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.moveObjects = function(a) {
    this.bob1_.setPosition(new mpl$lab$util$Vector(a[0],a[1]));
    this.bob1_.setVelocity(new mpl$lab$util$Vector(a[4],a[5],0));
    this.bob2_.setPosition(new mpl$lab$util$Vector(a[2],a[3]));
    this.bob2_.setVelocity(new mpl$lab$util$Vector(a[6],a[7],0));
    this.topMass_.setPosition(new mpl$lab$util$Vector(a[12],a[13]))
}
;
mpl$sims$springs$Double2DSpringSim.prototype.startDrag = function(a, b, c, d, e) {
    this.dragBlock_ = -1;
    return a == this.bob1_ ? (this.dragBlock_ = 0,
    !0) : a == this.bob2_ ? (this.dragBlock_ = 1,
    !0) : a == this.topMass_ ? !0 : !1
}
;
mpl$sims$springs$Double2DSpringSim.prototype.mouseDrag = function(a, b, c, d) {
    d = this.getVarsList();
    b = b.subtract(c);
    if (a == this.topMass_)
        d.setValue(12, b.getX()),
        d.setValue(13, b.getY());
    else if (0 <= this.dragBlock_ && 1 >= this.dragBlock_) {
        if (a != (0 == this.dragBlock_ ? this.bob1_ : this.bob2_))
            return;
        a = 2 * this.dragBlock_;
        d.setValue(a, b.getX());
        d.setValue(a + 1, b.getY());
        d.setValue(a + 4, 0);
        d.setValue(a + 5, 0);
        d.incrSequence(8, 9, 10)
    }
    this.moveObjects(d.getValues())
}
;
mpl$sims$springs$Double2DSpringSim.prototype.finishDrag = function(a, b, c) {
    this.dragBlock_ = -1
}
;
mpl$sims$springs$Double2DSpringSim.prototype.handleKeyEvent = function(a, b, c) {}
;
mpl$sims$springs$Double2DSpringSim.prototype.evaluate = function(a, b, c) {
    mpl$lab$util$Util.zeroArray(b);
    this.moveObjects(a);
    b[11] = 1;
    c = this.spring1_.calculateForces()[1].getVector();
    var d = this.spring2_.calculateForces()
      , e = d[0].getVector();
    d = d[1].getVector();
    var f = this.bob1_.getMass()
      , g = this.bob2_.getMass()
      , h = this.damping_;
    0 != this.dragBlock_ && (b[0] = a[4],
    b[1] = a[5],
    b[4] = (c.getX() + e.getX() - h * a[4]) / f,
    b[5] = -this.gravity_ + (c.getY() + e.getY() - h * a[5]) / f);
    1 != this.dragBlock_ && (b[2] = a[6],
    b[3] = a[7],
    b[6] = (d.getX() - h * a[6]) / g,
    b[7] = -this.gravity_ + (d.getY() - h * a[7]) / g);
    return null
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getGravity = function() {
    return this.gravity_
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setGravity = function(a) {
    this.gravity_ = a;
    this.getVarsList().incrSequence(9, 10);
    this.broadcastParameter(mpl$sims$springs$Double2DSpringSim.en.GRAVITY)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getMass1 = function() {
    return this.bob1_.getMass()
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setMass1 = function(a) {
    this.bob1_.setMass(a);
    this.getVarsList().incrSequence(8, 9, 10);
    this.broadcastParameter(mpl$sims$springs$Double2DSpringSim.en.MASS1)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getMass2 = function() {
    return this.bob2_.getMass()
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setMass2 = function(a) {
    this.bob2_.setMass(a);
    this.getVarsList().incrSequence(8, 9, 10);
    this.broadcastParameter(mpl$sims$springs$Double2DSpringSim.en.MASS2)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getLength = function() {
    return this.springs_[0].getRestLength()
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setLength = function(a) {
    for (var b = 0; b < this.springs_.length; b++)
        this.springs_[b].setRestLength(a);
    this.getVarsList().incrSequence(9, 10);
    this.broadcastParameter(mpl$sims$springs$Double2DSpringSim.en.LENGTH)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getStiffness = function() {
    return this.springs_[0].getStiffness()
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setStiffness = function(a) {
    for (var b = 0; b < this.springs_.length; b++)
        this.springs_[b].setStiffness(a);
    this.getVarsList().incrSequence(9, 10);
    this.broadcastParameter(mpl$sims$springs$Double2DSpringSim.en.STIFFNESS)
}
;
mpl$sims$springs$Double2DSpringSim.prototype.getDamping = function() {
    return this.damping_
}
;
mpl$sims$springs$Double2DSpringSim.prototype.setDamping = function(a) {
    this.damping_ = a;
    this.broadcastParameter(mpl$sims$springs$Double2DSpringSim.en.DAMPING)
}
;
mpl$sims$springs$Double2DSpringSim.en = {
    ANCHOR_X: "anchor X",
    ANCHOR_Y: "anchor Y",
...
mpl$sims$springs$Double2DSpringSim.de_strings = {
    ANCHOR_X: "Anker X",
    ANCHOR_Y: "Anker Y",
    X_POSITION: "X Position",
    Y_POSITION: "Y Position",
...
mpl$sims$springs$Double2DSpringSim.i18n = "de" === goog.LOCALE ? mpl$sims$springs$Double2DSpringSim.de_strings : mpl$sims$springs$Double2DSpringSim.en;
...
;
var mpl$sims$springs$Double2DSpringApp = function(a) {
    mpl$lab$util$Util.setErrorHandler();
    var b = new mpl$lab$util$DoubleRect(-6,-6,6,6)
      , c = new mpl$sims$springs$Double2DSpringSim
      , d = new mpl$lab$model$SimpleAdvance(c);
    mpl$sims$common$AbstractApp.call(this, a, b, c, d, c, c);
    this.layout.simCanvas.setBackground("white");
    this.protoBob = (new mpl$lab$view$DisplayShape).setFillStyle("blue");
    this.protoSpring = (new mpl$lab$view$DisplaySpring).setWidth(.3).setColorCompressed("#0c0").setColorExpanded("#6f6");
    this.topMass = (new mpl$lab$view$DisplayShape(this.simList.getPointMass("top"))).setFillStyle("red");
    ...
    this.bob1 = new mpl$lab$view$DisplayShape(this.simList.getPointMass("bob1"),this.protoBob);
    this.displayList.add(this.bob1);
    this.bob2 = new mpl$lab$view$DisplayShape(this.simList.getPointMass("bob2"),this.protoBob);
    this.displayList.add(this.bob2);
    this.addPlaybackControls();
    a = c.getParameterNumber(mpl$sims$springs$Double2DSpringSim.en.GRAVITY);
    this.addControl(new mpl$lab$controls$SliderControl(a,0,50,!1));
    a = c.getParameterNumber(mpl$sims$springs$Double2DSpringSim.en.DAMPING);
    this.addControl(new mpl$lab$controls$SliderControl(a,0,1,!1));
    a = c.getParameterNumber(mpl$sims$springs$Double2DSpringSim.en.MASS1);
    this.addControl(new mpl$lab$controls$SliderControl(a,.2,20.2,!0));
    a = c.getParameterNumber(mpl$sims$springs$Double2DSpringSim.en.MASS2);
    this.addControl(new mpl$lab$controls$SliderControl(a,.2,20.2,!0));
    
    a = c.getParameterNumber(mpl$sims$springs$Double2DSpringSim.en.STIFFNESS);
    this.addControl(new mpl$lab$controls$SliderControl(a,0,200,!1));
    this.addStandardControls();
    
    this.makeEasyScript();
    this.addURLScriptButton()
};
$jscomp.inherits(mpl$sims$springs$Double2DSpringApp, mpl$sims$common$AbstractApp);
mpl$sims$springs$Double2DSpringApp.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", bob1: " + this.bob1.toStringShort() + ", bob2: " + this.bob2.toStringShort() + ", spring1: " + this.spring1.toStringShort() + ", spring2: " + this.spring2.toStringShort() + ", topMass: " + this.topMass.toStringShort() + mpl$sims$common$AbstractApp.prototype.toString.call(this)
}
;
mpl$sims$springs$Double2DSpringApp.prototype.getClassName = function() {
    return "Double2DSpringApp"
}
;
mpl$sims$springs$Double2DSpringApp.prototype.defineNames = function(a) {
    mpl$sims$common$AbstractApp.prototype.defineNames.call(this, a);
    this.terminal.addRegex("topMass|bob1|bob2|spring1|spring2|protoBob|protoSpring", a + ".")
}
;
function module$contents$myphysicslab$sims$springs$Double2DSpringApp_makeDouble2DSpringApp(a) {
    return new mpl$sims$springs$Double2DSpringApp(a)
}
goog.exportSymbol("makeDouble2DSpringApp", module$contents$myphysicslab$sims$springs$Double2DSpringApp_makeDouble2DSpringApp);
