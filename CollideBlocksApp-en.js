...
mpl$lab$util$Util.COMPILE_TIME = "2019-05-12 11:35:05";
...
;
mpl$lab$util$EasyScriptParser.en = {
    URL_SCRIPT: "share",
...
mpl$sims$common$CommonControls.makePanZoomControls = function(a, b, c) {
    ...
    f = mpl$lab$util$Util.createImage(d + "bluebkdulls.png", 30);
...
mpl$sims$common$CommonControls.makePlaybackControls = function(a, b) {
    ...
    d.style.bottom = "0",
    d.style.opacity = .5);
    var e = mpl$lab$util$Util.createImage(c + "bluebkdulls.png", 30);
    b = new mpl$lab$controls$ButtonControl(mpl$lab$app$SimRunner.i18n.RESTART,goog.bind(a.reset, a),e);
    d.appendChild(b.getElement());
    e = mpl$lab$util$Util.createImage(c + "bluefwddulls.png", 30);
    var f = mpl$lab$util$Util.createImage(c + "blueplaydull.png", 30);
...
mpl$sims$common$CommonControls.makeShowClockParam = function(a, b, c) {
    ...
    b = new mpl$lab$util$ParameterBoolean(c,mpl$lab$view$DisplayClock.en.SHOW_CLOCK,mpl$lab$view$DisplayClock.i18n.SHOW_CLOCK,goog.bind(d.contains, d, a),function(b) {
        b ? d.add(a) : d.remove(a);
        c.broadcastParameter(mpl$lab$view$DisplayClock.en.SHOW_CLOCK)
    }
    );
    c.addParameter(b);
...
var mpl$sims$common$TabLayout = function(a, b, c) {
    ...
    this.sim_controls.style.position = "absolute";
    this.sim_controls.style.marginLeft = "-280px";
    this.sim_controls.style.marginTop = "50px";
    this.div_sim = mpl$sims$common$TabLayout.getElementById(a, "sim_applet");
    this.div_sim.style.position = "relative";
    ...
    this.addParameter(new mpl$lab$util$ParameterBoolean(this,mpl$sims$common$TabLayout.en.SHOW_TERMINAL,mpl$sims$common$TabLayout.i18n.SHOW_TERMINAL,goog.bind(function() {
        return this.show_term_cb.checked
    }, this),goog.bind(this.showTerminal, this)))
};
...
mpl$sims$common$TabLayout.prototype.alignCanvasControls = function(a, b, c) {
    ...
    b.style.columnCount = "2",
    b.style.MozColumnCount = "2",
    b.style.webkitColumnCount = "2")
}
;
...
mpl$sims$common$TabLayout.prototype.redoLayout = function() {
    ...
    case a.GRAPH:
        ...
        this.div_time_graph.style.display = "none";
        this.time_graph_controls.style.display = "none";
        this.setDisplaySize(.95 * this.graphWidth_, this.div_graph);
        this.alignCanvasControls(this.div_graph, this.graph_controls);
        this.show_sim_cb.checked = !1;
        this.show_sim_label.style.display = "inline";
        break;
    case a.GRAPH_AND_SIM:
        this.div_time_graph.style.display = "none";
        this.sim_controls.style.display = "none";
        this.time_graph_controls.style.display = "none";
        600 < b.width ? this.setDisplaySize(.49, this.div_graph) : this.setDisplaySize(.95 * this.graphWidth_, this.div_graph);
        this.alignCanvasControls(this.div_graph, this.graph_controls, this.div_sim);
        this.show_sim_cb.checked = !0;
        this.show_sim_label.style.display = "inline";
        break;
    case a.TIME_GRAPH:
        this.div_graph.style.display = "none";
        ...
        this.show_sim_label.style.display = "inline";
        break;
    case a.TIME_GRAPH_AND_SIM:
        this.div_graph.style.display = "none";
        this.sim_controls.style.display = "none";
        this.graph_controls.style.display = "none";
        600 < b.width ? this.setDisplaySize(.49, this.div_time_graph) : this.setDisplaySize(.95 * this.timeGraphWidth_, this.div_time_graph);
        this.alignCanvasControls(this.div_time_graph, this.time_graph_controls, this.div_sim);
        this.show_sim_cb.checked = !0;
        this.show_sim_label.style.display = "inline";
        break;
    case a.MULTI_GRAPH:
        ...
        this.graph_controls.style.display = "none";
        this.time_graph_controls.style.display = "none";
        this.setDisplaySize(.49, this.div_graph);
        this.setDisplaySize(.49, this.div_time_graph);
        this.show_sim_cb.checked = !1;
        this.show_sim_label.style.display = "inline";
        break;
    case a.MULTI_GRAPH_AND_SIM:
        this.div_graph.style.display = "block";
        this.div_time_graph.style.display = "block";
...
mpl$sims$common$AbstractApp.prototype.addStandardControls = function() {
    ...
    this.addControl(new mpl$lab$controls$CheckBoxControl(this.panZoomParam));
    var a = this.simRun.getParameterNumber(mpl$lab$app$SimRunner.en.TIME_STEP);
    this.addControl(new mpl$lab$controls$NumericControl(a));
    a = this.simRun.getClock().getParameterNumber(mpl$lab$util$Clock.en.TIME_RATE);
    this.addControl(new mpl$lab$controls$NumericControl(a));
    a = this.diffEqSolver.getParameterString(mpl$lab$model$DiffEqSolverSubject.en.DIFF_EQ_SOLVER);
    this.addControl(new mpl$lab$controls$ChoiceControl(a));
    a = mpl$sims$common$CommonControls.makeBackgroundMenu(this.layout.simCanvas);
    this.addControl(a);
    mpl$lab$util$Util.DEBUG && this.addControl(new mpl$lab$controls$LabelControl("compiled " + mpl$lab$util$Util.COMPILE_TIME))
}
;
...
;
var mpl$lab$model$Collision = function() {};
mpl$lab$model$Collision.prototype.bilateral = function() {}
;
mpl$lab$model$Collision.prototype.closeEnough = function(a) {}
;
mpl$lab$model$Collision.prototype.contact = function() {}
;
mpl$lab$model$Collision.prototype.getDetectedTime = function() {}
;
mpl$lab$model$Collision.prototype.getDistance = function() {}
;
mpl$lab$model$Collision.prototype.getEstimatedTime = function() {}
;
mpl$lab$model$Collision.prototype.getImpulse = function() {}
;
mpl$lab$model$Collision.prototype.getVelocity = function() {}
;
mpl$lab$model$Collision.prototype.illegalState = function() {}
;
mpl$lab$model$Collision.prototype.isColliding = function() {}
;
mpl$lab$model$Collision.prototype.isTouching = function() {}
;
mpl$lab$model$Collision.prototype.needsHandling = function() {}
;
mpl$lab$model$Collision.prototype.setNeedsHandling = function(a) {}
;
mpl$lab$model$Collision.prototype.updateCollision = function(a) {}
;
var mpl$sims$springs$BlockCollision = function(a, b, c) {
    this.leftBlock_ = a;
    this.rightBlock_ = b;
    this.detectedTime_ = c;
    this.distance_ = NaN;
    this.mustHandle_ = !1;
    this.accuracy_ = this.targetGap_ = .005;
    this.impulse = mpl$lab$util$Util.NaN;
    this.updateCollision(c)
};
mpl$sims$springs$BlockCollision.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : "BlockCollision{distance: " + mpl$lab$util$Util.NF5(this.distance_) + ", targetGap: " + mpl$lab$util$Util.NF5(this.targetGap_) + ", accuracy: " + mpl$lab$util$Util.NF5(this.accuracy_) + ", detectedTime: " + mpl$lab$util$Util.NF7(this.detectedTime_) + ", impulse: " + mpl$lab$util$Util.NF5(this.impulse) + ", mustHandle: " + this.mustHandle_ + ", leftBlock: " + this.leftBlock_ + ", rightBlock: " + this.rightBlock_ + "}"
}
;
mpl$sims$springs$BlockCollision.prototype.bilateral = function() {
    return !1
}
;
mpl$sims$springs$BlockCollision.prototype.closeEnough = function(a) {
    return a ? 0 < this.distance_ && this.distance_ < this.targetGap_ + this.accuracy_ : Math.abs(this.distance_ - this.targetGap_) <= this.accuracy_
}
;
mpl$sims$springs$BlockCollision.prototype.contact = function() {
    return !1
}
;
mpl$sims$springs$BlockCollision.prototype.getDetectedTime = function() {
    return this.detectedTime_
}
;
mpl$sims$springs$BlockCollision.prototype.getDistance = function() {
    return this.distance_
}
;
mpl$sims$springs$BlockCollision.prototype.getEstimatedTime = function() {
    return mpl$lab$util$Util.NaN
}
;
mpl$sims$springs$BlockCollision.prototype.getImpulse = function() {
    return this.impulse
}
;
mpl$sims$springs$BlockCollision.prototype.getVelocity = function() {
    return this.rightBlock_.getVelocity().subtract(this.leftBlock_.getVelocity()).getX()
}
;
mpl$sims$springs$BlockCollision.prototype.illegalState = function() {
    return 0 > this.distance_
}
;
mpl$sims$springs$BlockCollision.prototype.isColliding = function() {
    return this.distance_ < this.targetGap_ - this.accuracy_
}
;
mpl$sims$springs$BlockCollision.prototype.isTouching = function() {
    return this.distance_ < 2 * this.targetGap_
}
;
mpl$sims$springs$BlockCollision.prototype.needsHandling = function() {
    return this.mustHandle_
}
;
mpl$sims$springs$BlockCollision.prototype.setNeedsHandling = function(a) {
    this.mustHandle_ = a
}
;
mpl$sims$springs$BlockCollision.prototype.similarTo = function(a) {
    return a.leftBlock_ == this.leftBlock_ && a.rightBlock_ == this.rightBlock_
}
;
mpl$sims$springs$BlockCollision.prototype.updateCollision = function(a) {
    this.distance_ = this.rightBlock_.getLeftWorld() - this.leftBlock_.getRightWorld()
}
;
var mpl$lab$model$CollisionTotals = function() {
    this.backups_ = this.steps_ = this.collisions_ = this.impulses_ = this.searches_ = 0
};
mpl$lab$model$CollisionTotals.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : "CollisionTotals{searches: " + this.searches_ + ", impulses: " + this.impulses_ + ", collisions: " + this.collisions_ + ", steps: " + this.steps_ + ", backups: " + this.backups_ + "}"
}
;
mpl$lab$model$CollisionTotals.prototype.addBackups = function(a) {
    this.backups_ += a
}
;
mpl$lab$model$CollisionTotals.prototype.addCollisions = function(a) {
    this.collisions_ += a
}
;
mpl$lab$model$CollisionTotals.prototype.addImpulses = function(a) {
    this.impulses_ += a
}
;
mpl$lab$model$CollisionTotals.prototype.addSearches = function(a) {
    this.searches_ += a
}
;
mpl$lab$model$CollisionTotals.prototype.addSteps = function(a) {
    this.steps_ += a
}
;
mpl$lab$model$CollisionTotals.prototype.getBackups = function() {
    return this.backups_
}
;
mpl$lab$model$CollisionTotals.prototype.getCollisions = function() {
    return this.collisions_
}
;
mpl$lab$model$CollisionTotals.prototype.getImpulses = function() {
    return this.impulses_
}
;
mpl$lab$model$CollisionTotals.prototype.getSearches = function() {
    return this.searches_
}
;
mpl$lab$model$CollisionTotals.prototype.getSteps = function() {
    return this.steps_
}
;
mpl$lab$model$CollisionTotals.prototype.reset = function() {
    this.backups_ = this.searches_ = this.steps_ = this.collisions_ = this.impulses_ = 0
}
;
var mpl$lab$model$CollisionSim = function(a) {};
mpl$lab$model$CollisionSim.prototype.findCollisions = function(a, b, c) {}
;
mpl$lab$model$CollisionSim.prototype.handleCollisions = function(a, b) {}
;
mpl$lab$model$CollisionSim.prototype.setDebugPaint = function(a) {}
;
var mpl$sims$springs$CollideBlocksSim = function(a) {
    mpl$lab$model$AbstractODESim.call(this, a);
    this.damping_ = 0;
    this.setVarsList(new mpl$lab$model$VarsList([mpl$sims$springs$CollideBlocksSim.en.POSITION_1, mpl$sims$springs$CollideBlocksSim.en.VELOCITY_1, mpl$sims$springs$CollideBlocksSim.en.POSITION_2, mpl$sims$springs$CollideBlocksSim.en.VELOCITY_2, mpl$lab$model$VarsList.en.TIME, mpl$lab$model$EnergySystem.en.KINETIC_ENERGY, mpl$lab$model$EnergySystem.en.POTENTIAL_ENERGY, mpl$lab$model$EnergySystem.en.TOTAL_ENERGY],[mpl$sims$springs$CollideBlocksSim.i18n.POSITION_1, mpl$sims$springs$CollideBlocksSim.i18n.VELOCITY_1, mpl$sims$springs$CollideBlocksSim.i18n.POSITION_2, mpl$sims$springs$CollideBlocksSim.i18n.VELOCITY_2, mpl$lab$model$VarsList.i18n.TIME, mpl$lab$model$EnergySystem.i18n.KINETIC_ENERGY, mpl$lab$model$EnergySystem.i18n.POTENTIAL_ENERGY, mpl$lab$model$EnergySystem.i18n.TOTAL_ENERGY],this.getName() + "_SIM"));
    this.getVarsList().setComputed(5, 6, 7);
    this.wallLeft_ = mpl$lab$model$PointMass.makeRectangle(.4, 4, "wallLeft").setMass(mpl$lab$util$Util.POSITIVE_INFINITY);
    this.wallLeft_.setPosition(new mpl$lab$util$Vector(-.2,0));
    this.wallRight_ = mpl$lab$model$PointMass.makeRectangle(.4, 4, "wallRight").setMass(mpl$lab$util$Util.POSITIVE_INFINITY);
    this.wallRight_.setPosition(new mpl$lab$util$Vector(7.2,0));
    this.block1_ = mpl$lab$model$PointMass.makeSquare(.6, "block1").setMass(.5);
    this.block2_ = mpl$lab$model$PointMass.makeSquare(.6, "block2").setMass(1.5);
    this.spring1_ = new mpl$lab$model$Spring("spring1",this.wallLeft_,new mpl$lab$util$Vector(this.wallLeft_.getWidth() / 2,0),this.block1_,mpl$lab$util$Vector.ORIGIN,2.5,6);
    this.spring2_ = new mpl$lab$model$Spring("spring2",this.wallRight_,new mpl$lab$util$Vector(-this.wallRight_.getWidth() / 2,0),this.block2_,mpl$lab$util$Vector.ORIGIN,2.5,0);
    this.potentialOffset_ = 0;
    this.debugPaint_ = null;
    this.isDragging = !1;
    this.getVarsList().setValues([.5, 0, 3, 0]);
    this.saveInitialState();
    this.getSimList().add(this.wallLeft_, this.wallRight_, this.spring1_, this.spring2_, this.block1_, this.block2_);
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.MASS_1,mpl$sims$springs$CollideBlocksSim.i18n.MASS_1,goog.bind(this.getMass1, this),goog.bind(this.setMass1, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.MASS_2,mpl$sims$springs$CollideBlocksSim.i18n.MASS_2,goog.bind(this.getMass2, this),goog.bind(this.setMass2, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.LENGTH_1,mpl$sims$springs$CollideBlocksSim.i18n.LENGTH_1,goog.bind(this.getSpring1Length, this),goog.bind(this.setSpring1Length, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.STIFFNESS_1,mpl$sims$springs$CollideBlocksSim.i18n.STIFFNESS_1,goog.bind(this.getSpring1Stiffness, this),goog.bind(this.setSpring1Stiffness, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.LENGTH_2,mpl$sims$springs$CollideBlocksSim.i18n.LENGTH_2,goog.bind(this.getSpring2Length, this),goog.bind(this.setSpring2Length, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.STIFFNESS_2,mpl$sims$springs$CollideBlocksSim.i18n.STIFFNESS_2,goog.bind(this.getSpring2Stiffness, this),goog.bind(this.setSpring2Stiffness, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$CollideBlocksSim.en.DAMPING,mpl$sims$springs$CollideBlocksSim.i18n.DAMPING,goog.bind(this.getDamping, this),goog.bind(this.setDamping, this)))
};
$jscomp.inherits(mpl$sims$springs$CollideBlocksSim, mpl$lab$model$AbstractODESim);
mpl$sims$springs$CollideBlocksSim.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", block1_: " + this.block1_ + ", block2_: " + this.block2_ + ", wallLeft_: " + this.wallLeft_ + ", wallRight_: " + this.wallRight_ + ", spring1_: " + this.spring1_ + ", spring2_: " + this.spring2_ + mpl$lab$model$AbstractODESim.prototype.toString.call(this)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getClassName = function() {
    return "CollideBlocksSim"
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getEnergyInfo = function() {
    var a = this.getVarsList().getValues();
    this.moveObjects(a);
    return this.getEnergyInfo_(a)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getEnergyInfo_ = function(a) {
    a = this.block1_.getKineticEnergy() + this.block2_.getKineticEnergy();
    var b = this.spring1_.getPotentialEnergy() + this.spring2_.getPotentialEnergy();
    return new mpl$lab$model$EnergyInfo(b + this.potentialOffset_,a)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setPotentialEnergy = function(a) {
    this.potentialOffset_ = 0;
    this.potentialOffset_ = a - this.getEnergyInfo().getPotential()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.modifyObjects = function() {
    var a = this.getVarsList()
      , b = a.getValues();
    this.moveObjects(b);
    var c = this.getEnergyInfo_(b);
    b[5] = c.getTranslational();
    b[6] = c.getPotential();
    b[7] = c.getTotalEnergy();
    a.setValues(b, !0)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.moveObjects = function(a) {
    this.block1_.setPosition(new mpl$lab$util$Vector(a[0],0));
    this.block1_.setVelocity(new mpl$lab$util$Vector(a[1],0,0));
    this.block2_.setPosition(new mpl$lab$util$Vector(a[2],0));
    this.block2_.setVelocity(new mpl$lab$util$Vector(a[3],0,0));
    null != this.debugPaint_ && this.debugPaint_()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setDebugPaint = function(a) {
    this.debugPaint_ = a
}
;
mpl$sims$springs$CollideBlocksSim.prototype.startDrag = function(a, b, c, d, e) {
    return a == this.block1_ || a == this.block2_ ? this.isDragging = !0 : !1
}
;
mpl$sims$springs$CollideBlocksSim.prototype.mouseDrag = function(a, b, c, d) {
    d = this.getVarsList();
    var e = d.getValues();
    b = b.subtract(c);
    a == this.block1_ ? (a = b.getX(),
    a - this.block1_.getWidth() / 2 < this.wallLeft_.getRightWorld() + .02 && (a = this.wallLeft_.getRightWorld() + this.block1_.getWidth() / 2 + .02),
    a + this.block1_.getWidth() / 2 + this.block2_.getWidth() > this.wallRight_.getLeftWorld() - .04 && (a = this.wallRight_.getLeftWorld() - this.block2_.getWidth() - this.block1_.getWidth() / 2 - .04),
    a + this.block1_.getWidth() / 2 > this.block2_.getLeftWorld() - .02 && this.block2_.setPosition(new mpl$lab$util$Vector(a + this.block1_.getWidth() / 2 + this.block2_.getWidth() / 2 + .02,0)),
    e[0] = a,
    e[1] = 0,
    e[2] = this.block2_.getPosition().getX(),
    e[3] = 0,
    d.setValues(e)) : a == this.block2_ && (a = b.getX(),
    a + this.block2_.getWidth() / 2 > this.wallRight_.getLeftWorld() - .02 && (a = this.wallRight_.getLeftWorld() - this.block2_.getWidth() / 2 - .02),
    a - this.block2_.getWidth() / 2 - this.block1_.getWidth() < this.wallLeft_.getRightWorld() + .04 && (a = this.wallLeft_.getRightWorld() + this.block1_.getWidth() + this.block2_.getWidth() / 2 + .04),
    a - this.block2_.getWidth() / 2 < this.block1_.getRightWorld() + .02 && this.block1_.setPosition(new mpl$lab$util$Vector(a - this.block2_.getWidth() / 2 - this.block1_.getWidth() / 2 - .02,0)),
    e[0] = this.block1_.getPosition().getX(),
    e[1] = 0,
    e[2] = a,
    e[3] = 0,
    d.setValues(e));
...
;
mpl$sims$springs$CollideBlocksSim.prototype.finishDrag = function(a, b, c) {
    this.isDragging = !1
}
;
mpl$sims$springs$CollideBlocksSim.prototype.handleKeyEvent = function(a, b, c) {}
;
mpl$sims$springs$CollideBlocksSim.prototype.addCollision = function(a, b, c, d) {
    var e = new mpl$sims$springs$BlockCollision(b,c,d);
    .1 > e.getDistance() && ((b = goog.array.find(a, function(a, b, c) {
        return e.similarTo(a)
    })) ? !b.needsHandling() && e.getDistance() < b.getDistance() && (goog.array.remove(a, b),
    a.push(e)) : a.push(e))
}
;
mpl$sims$springs$CollideBlocksSim.prototype.findCollisions = function(a, b, c) {
    this.moveObjects(b);
    b = this.getTime() + c;
    this.addCollision(a, this.wallLeft_, this.block1_, b);
    this.addCollision(a, this.block1_, this.block2_, b);
    this.addCollision(a, this.block2_, this.wallRight_, b)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.handleCollisions = function(a, b) {
    var c = this.getVarsList()
      , d = c.getVariable(0).getSequence()
      , e = c.getVariable(2).getSequence()
      , f = c.getValues();
    goog.array.forEach(a, function(a) {
        if (a.leftBlock_ == this.wallLeft_ && a.rightBlock_ == this.block1_)
            a.impulse = Math.abs(f[1] * this.block1_.getMass()),
            c.setValue(1, -f[1]);
        else if (a.rightBlock_ == this.wallRight_ && a.leftBlock_ == this.block2_)
            a.impulse = Math.abs(f[3] * this.block2_.getMass()),
            c.setValue(3, -f[3]);
        else if (a.leftBlock_ == this.block1_ && a.rightBlock_ == this.block2_) {
            var d = (this.block1_.getMass() * f[1] + this.block2_.getMass() * f[3]) / (this.block1_.getMass() + this.block2_.getMass());
            a.impulse = Math.abs(2 * (d - f[3]) * this.block2_.getMass());
            c.setValue(1, -f[1] + 2 * d);
            c.setValue(3, -f[3] + 2 * d)
        } else
            throw Error("illegal collision " + a);
        b && b.addImpulses(1)
    }, this);
    goog.asserts.assert(c.getVariable(0).getSequence() == d);
    goog.asserts.assert(c.getVariable(2).getSequence() == e);
    return !0
}
;
mpl$sims$springs$CollideBlocksSim.prototype.evaluate = function(a, b, c) {
    mpl$lab$util$Util.zeroArray(b);
    b[4] = 1;
    this.moveObjects(a);
    this.isDragging || (b[0] = a[1],
    b[1] = (-this.spring1_.getStiffness() * this.spring1_.getStretch() - this.damping_ * a[1]) / this.block1_.getMass(),
    b[2] = a[3],
    b[3] = (this.spring2_.getStiffness() * this.spring2_.getStretch() - this.damping_ * a[3]) / this.block2_.getMass());
    return null
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getMomentum = function() {
    this.modifyObjects();
    var a = this.block1_.getVelocity().multiply(this.block1_.getMass())
      , b = this.block2_.getVelocity().multiply(this.block2_.getMass());
    return a.add(b).length()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getMass1 = function() {
    return this.block1_.getMass()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setMass1 = function(a) {
    this.block1_.setMass(a);
    this.getVarsList().incrSequence(5, 6, 7);
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.MASS_1)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getMass2 = function() {
    return this.block2_.getMass()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setMass2 = function(a) {
    this.block2_.setMass(a);
    this.getVarsList().incrSequence(5, 6, 7);
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.MASS_2)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getDamping = function() {
    return this.damping_
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setDamping = function(a) {
    this.damping_ = a;
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.DAMPING)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getSpring1Stiffness = function() {
    return this.spring1_.getStiffness()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setSpring1Stiffness = function(a) {
    this.spring1_.setStiffness(a);
    this.getVarsList().incrSequence(6, 7);
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.STIFFNESS_1)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getSpring1Length = function() {
    return this.spring1_.getRestLength()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setSpring1Length = function(a) {
    this.spring1_.setRestLength(a);
    this.getVarsList().incrSequence(6, 7);
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.LENGTH_1)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getSpring2Stiffness = function() {
    return this.spring2_.getStiffness()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setSpring2Stiffness = function(a) {
    this.spring2_.setStiffness(a);
    this.getVarsList().incrSequence(6, 7);
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.STIFFNESS_2)
}
;
mpl$sims$springs$CollideBlocksSim.prototype.getSpring2Length = function() {
    return this.spring2_.getRestLength()
}
;
mpl$sims$springs$CollideBlocksSim.prototype.setSpring2Length = function(a) {
    this.spring2_.setRestLength(a);
    this.getVarsList().incrSequence(6, 7);
    this.broadcastParameter(mpl$sims$springs$CollideBlocksSim.en.LENGTH_2)
}
;
mpl$sims$springs$CollideBlocksSim.en = {
...
mpl$sims$springs$CollideBlocksSim.de_strings = {
...
mpl$sims$springs$CollideBlocksSim.i18n = "de" === goog.LOCALE ? mpl$sims$springs$CollideBlocksSim.de_strings : mpl$sims$springs$CollideBlocksSim.en;
var mpl$lab$model$CollisionStats = function() {
    this.numImminent = this.numNeedsHandling = this.numNonContact = this.numContacts = this.numJoints = this.numCollisions = 0;
    var a = mpl$lab$util$Util.POSITIVE_INFINITY;
    this.detectedTime = this.estTime = this.minDistance = a
};
mpl$lab$model$CollisionStats.prototype.toString = function() {
    if (mpl$lab$util$Util.ADVANCED)
        return "";
    var a = "CollisionStats{collisions: " + this.numCollisions;
    0 < this.numCollisions && (a += ", estTime: " + mpl$lab$util$Util.NF7(this.estTime) + ", detectedTime: " + mpl$lab$util$Util.NF7(this.detectedTime) + ", needsHandling: " + this.numNeedsHandling + ", minDistance: " + mpl$lab$util$Util.NF7(this.minDistance) + ", nonContact: " + this.numNonContact + ", imminent: " + this.numImminent + ", joints: " + this.numJoints + ", contacts: " + this.numContacts);
    return a + "}"
}
;
mpl$lab$model$CollisionStats.prototype.clear = function() {
    this.numImminent = this.numNeedsHandling = this.numNonContact = this.numContacts = this.numJoints = this.numCollisions = 0;
    var a = mpl$lab$util$Util.POSITIVE_INFINITY;
    this.detectedTime = this.estTime = this.minDistance = a
}
;
mpl$lab$model$CollisionStats.prototype.update = function(a) {
    var b = mpl$lab$util$Util.POSITIVE_INFINITY;
    this.clear();
    this.numCollisions = a.length;
    goog.array.forEach(a, function(a) {
        a.bilateral() ? this.numJoints++ : a.contact() && this.numContacts++;
        a.contact() || this.numNonContact++;
        a.needsHandling() && (this.numNeedsHandling++,
        a.getDetectedTime() < this.detectedTime && (this.detectedTime = a.getDetectedTime()));
        if ((a.needsHandling() || !a.contact()) && 0 > a.getVelocity()) {
            this.numImminent++;
            var b = a.getDistance();
            if (!isFinite(b))
                throw Error("distance is NaN " + a);
            b < this.minDistance && (this.minDistance = b);
            isNaN(this.estTime) || (a = a.getEstimatedTime(),
            isNaN(a) ? this.estTime = mpl$lab$util$Util.NaN : a < this.estTime && (this.estTime = a))
        }
    }, this);
    this.estTime == b && (this.estTime = mpl$lab$util$Util.NaN);
    this.detectedTime == b && (this.detectedTime = mpl$lab$util$Util.NaN)
}
;
var mpl$lab$model$CollisionAdvance = function(a, b) {
    this.sim_ = a;
    this.odeSolver_ = b || new mpl$lab$model$RungeKutta(a);
    this.timeStep_ = .025;
    this.wayPoints_ = [mpl$lab$model$CollisionAdvance.WayPoint.STUCK];
    this.jointSmallImpacts_ = !1;
    this.printTime_ = mpl$lab$util$Util.NEGATIVE_INFINITY;
    this.collisionTotals_ = new mpl$lab$model$CollisionTotals;
    this.totalTimeStep_ = this.timeAdvanced_ = this.currentStep_ = 0;
    this.nextEstimate_ = mpl$lab$util$Util.NaN;
    this.collisions_ = [];
    this.stats_ = new mpl$lab$model$CollisionStats;
    this.removedCollisions_ = [];
    this.binarySearch_ = !1;
    this.binarySteps_ = 0;
    this.detectedTime_ = NaN;
    this.stuckCount_ = 0;
    this.debugPaint_ = null;
    this.collisionCounter_ = this.numClose_ = this.backupCount_ = this.odeSteps_ = 0
};
mpl$lab$model$CollisionAdvance.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", odeSolver_: " + this.odeSolver_.toStringShort() + ", jointSmallImpacts_: " + this.jointSmallImpacts_ + "}"
}
;
mpl$lab$model$CollisionAdvance.prototype.toStringShort = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : "CollisionAdvance{sim_: " + this.sim_.toStringShort() + "}"
}
;
mpl$lab$model$CollisionAdvance.prototype.addWayPoints = function(a) {
    this.wayPoints_ = goog.array.concat(this.wayPoints_, a)
}
;
mpl$lab$model$CollisionAdvance.prototype.advance = function(a, b) {
    var c = mpl$lab$model$CollisionAdvance.WayPoint;
    if (1E-16 > a)
        this.sim_.modifyObjects();
    else {
        this.sim_.getSimList().removeTemporary(this.sim_.getTime() + a);
        this.timeAdvanced_ = 0;
        this.currentStep_ = this.totalTimeStep_ = a;
        this.binarySteps_ = 0;
        this.binarySearch_ = !1;
        this.nextEstimate_ = this.detectedTime_ = mpl$lab$util$Util.NaN;
        this.numClose_ = this.collisionCounter_ = this.odeSteps_ = this.backupCount_ = this.stuckCount_ = 0;
        this.stats_.clear();
        this.collisions_ = [];
        this.sim_.getVarsList().saveHistory();
        this.print(c.START);
        for (a = !1; this.timeAdvanced_ < this.totalTimeStep_ - 1E-16; ) {
            var d = this.do_advance_sim(this.currentStep_);
            this.stats_.update(this.collisions_);
            goog.asserts.assert(d || 0 < this.stats_.numNeedsHandling);
            this.print(c.ADVANCE_SIM_FINISH);
            var e = !1;
            if (0 < this.stats_.numNeedsHandling && (this.detectedTime_ = this.stats_.detectedTime,
            this.do_backup(this.currentStep_),
            e = !0,
            this.stats_.update(this.collisions_),
            this.print(c.PRE_COLLISION),
            this.stuckCount_++,
            3 <= this.stuckCount_ && (this.binarySearch_ || (this.print(c.MAYBE_STUCK),
            this.binarySearch_ = !0),
            this.stuckCount_ >= mpl$lab$model$CollisionAdvance.MAX_STUCK_COUNT)))
                throw this.print(c.STUCK),
                Error("collision was not resolved after " + this.stuckCount_ + " tries");
            this.numClose_ = goog.array.count(this.collisions_, function(a) {
                return (a.needsHandling() || !a.contact()) && 0 > a.getVelocity() && a.closeEnough(e)
            });
            0 < this.numClose_ && (this.removedCollisions_ = [],
            this.removeDistant(e) && this.print(c.HANDLE_REMOVE_DISTANT),
            d = this.do_handle_collision(this.numClose_),
            a = a || d,
            this.nextEstimate_ = NaN,
            this.stats_.update(this.removedCollisions_));
            e || (1E-7 < this.currentStep_ && (this.stuckCount_ = 0),
            this.timeAdvanced_ += this.currentStep_,
            this.print(c.ADVANCED_NO_BACKUP),
            void 0 !== b && b.memorize(),
            this.binarySearch_ && 2 <= ++this.binarySteps_ ? (this.print(c.BINARY_SEARCH_FAIL),
            this.binarySearch_ = !1,
            this.binarySteps_ = 0,
            this.detectedTime_ = NaN) : isFinite(this.nextEstimate_) && (this.binarySearch_ = !0,
            this.print(c.ESTIMATE_FAILED)));
            this.checkNoneCollide();
            this.calc_next_step(e)
        }
        !a && this.jointSmallImpacts_ && 0 < this.stats_.numJoints && this.do_small_impacts();
        ...
        this.print(c.SUMMARY);
        this.print(c.FINISH)
    }
}
;
mpl$lab$model$CollisionAdvance.prototype.allVelocities = function(a) {
    return goog.array.map(a, function(a, c, d) {
        return a.getVelocity()
    })
}
;
mpl$lab$model$CollisionAdvance.prototype.calc_next_step = function(a) {
    var b = mpl$lab$model$CollisionAdvance.WayPoint;
    this.nextEstimate_ = this.stats_.estTime;
    this.binarySearch_ || (this.nextEstimate_ < this.sim_.getTime() && (this.binarySearch_ = !0,
    this.print(b.ESTIMATE_IN_PAST)),
    0 < this.stats_.numNeedsHandling && isNaN(this.nextEstimate_) && (this.binarySearch_ = !0,
    this.print(b.NO_ESTIMATE)));
    var c = this.totalTimeStep_ - this.timeAdvanced_;
    this.binarySearch_ ? (this.nextEstimate_ = NaN,
    a && (this.currentStep_ /= 2,
    this.binarySteps_ = 0),
    this.currentStep_ = Math.min(this.currentStep_, c),
    this.print(b.NEXT_STEP_BINARY)) : isNaN(this.nextEstimate_) ? (this.currentStep_ = c,
    this.print(b.NEXT_STEP_FULL)) : (a = this.nextEstimate_ - this.sim_.getTime(),
    goog.asserts.assert(0 <= a),
    this.currentStep_ = Math.min(a, c),
    this.print(b.NEXT_STEP_ESTIMATE))
}
;
mpl$lab$model$CollisionAdvance.prototype.checkNoneCollide = function() {
    if (mpl$lab$util$Util.DEBUG) {
        var a = 0;
        goog.array.forEach(this.collisions_, function(b) {
            b.illegalState() && a++
        }, this);
        if (0 < a)
            throw null != this.debugPaint_ && this.debugPaint_(),
            this.myPrint("TROUBLE: found " + a + " colliding at end of loop"),
            this.myPrint("stats " + this.stats_),
            this.printCollisions("TROUBLE", !0),
            console.log(this.sim_.getVarsList().printHistory()),
            Error("checkNoneCollide numIllegal=" + a);
    }
}
;
mpl$lab$model$CollisionAdvance.prototype.do_advance_sim = function(a) {
    var b = mpl$lab$model$CollisionAdvance.WayPoint;
    goog.asserts.assert(!isNaN(a) && isFinite(a));
    this.collisions_ = [];
    this.sim_.saveState();
    mpl$lab$util$Util.DEBUG && 1E-15 >= a && this.myPrint("*** WARNING tiny time step = " + mpl$lab$util$Util.NFE(a));
    this.print(b.ADVANCE_SIM_START);
    var c = this.odeSolver_.step(a);
    this.sim_.modifyObjects();
    mpl$lab$util$Util.DEBUG && null != this.debugPaint_ && this.debugPaint_();
    this.odeSteps_++;
    if (null != c)
        this.collisions_ = c,
        this.print(b.ADVANCE_SIM_FAIL);
    else {
        var d = this.sim_.getVarsList().getValues();
        this.sim_.findCollisions(this.collisions_, d, a);
        this.print(b.ADVANCE_SIM_COLLIDING)
    }
    goog.array.stableSort(this.collisions_, function(a, b) {
        a = Math.round(1E7 * a.getEstimatedTime());
        b = Math.round(1E7 * b.getEstimatedTime());
        return isNaN(a) ? isNaN(b) ? 0 : 1 : isNaN(b) ? -1 : a < b ? -1 : a > b ? 1 : 0
    });
    goog.array.forEach(this.collisions_, function(a) {
        a.setNeedsHandling(a.isColliding())
    });
    return null == c
}
;
mpl$lab$model$CollisionAdvance.prototype.do_backup = function(a) {
    this.print(mpl$lab$model$CollisionAdvance.WayPoint.POST_COLLISION);
    this.sim_.restoreState();
    this.sim_.modifyObjects();
    mpl$lab$util$Util.DEBUG && null != this.debugPaint_ && this.debugPaint_();
    this.backupCount_++;
    for (var b = this.sim_.getTime(), c = this.collisions_.length - 1; 0 <= c; c--) {
        var d = this.collisions_[c];
        d.isColliding() ? d.updateCollision(b) : goog.array.removeAt(this.collisions_, c)
    }
    b = this.sim_.getVarsList().getValues();
    this.sim_.findCollisions(this.collisions_, b, a)
}
;
mpl$lab$model$CollisionAdvance.prototype.do_handle_collision = function(a) {
    var b = mpl$lab$model$CollisionAdvance.WayPoint;
    this.print(b.HANDLE_COLLISION_START);
    this.print(b.COLLISIONS_TO_HANDLE);
    if (this.sim_.handleCollisions(this.collisions_, this.collisionTotals_)) {
        this.sim_.modifyObjects();
        var c = this.sim_.getTime();
        goog.array.forEach(this.collisions_, function(a) {
            a.updateCollision(c)
        });
        this.print(b.HANDLE_COLLISION_SUCCESS);
        this.binarySearch_ && this.collisionTotals_.addSearches(1);
        this.collisionCounter_ += a;
        this.binarySearch_ = !1;
        this.binarySteps_ = 0;
        this.detectedTime_ = NaN;
        return !0
    ...
    this.binarySearch_ = !0;
    this.print(b.HANDLE_COLLISION_FAIL);
    return !1
}
;
mpl$lab$model$CollisionAdvance.prototype.do_small_impacts = function() {
    var a = mpl$lab$model$CollisionAdvance.WayPoint;
    if (0 < this.collisions_.length) {
        this.print(a.SMALL_IMPACTS_START);
        this.removeDistant(!1);
        this.sim_.handleCollisions(this.collisions_, this.collisionTotals_);
        this.sim_.modifyObjects();
        if (mpl$lab$util$Util.DEBUG) {
            var b = this.sim_.getTime();
            goog.array.forEach(this.collisions_, function(a) {
                a.updateCollision(b)
            })
        }
        this.print(a.SMALL_IMPACTS_FINISH);
        this.print(a.SMALL_IMPACTS)
    }
}
;
mpl$lab$model$CollisionAdvance.prototype.getCollisionTotals = function() {
    return this.collisionTotals_
}
;
mpl$lab$model$CollisionAdvance.prototype.getDiffEqSolver = function() {
    return this.odeSolver_
}
;
mpl$lab$model$CollisionAdvance.prototype.getJointSmallImpacts = function() {
    return this.jointSmallImpacts_
}
;
mpl$lab$model$CollisionAdvance.prototype.getTime = function() {
    return this.sim_.getTime()
}
;
mpl$lab$model$CollisionAdvance.prototype.getTimeStep = function() {
    return this.timeStep_
}
;
mpl$lab$model$CollisionAdvance.prototype.getWayPoints = function() {
    return goog.array.clone(this.wayPoints_)
}
;
mpl$lab$model$CollisionAdvance.prototype.jointFlags = function(a) {
    return goog.array.map(a, function(a, c, d) {
        return a.bilateral()
    })
}
;
mpl$lab$model$CollisionAdvance.prototype.maxImpulse = function(a) {
    return goog.array.reduce(a, function(a, c, d, e) {
        c = c.getImpulse();
        return isFinite(c) ? Math.max(a, c) : a
    }, 0)
}
;
mpl$lab$model$CollisionAdvance.prototype.minVelocity = function(a) {
    return goog.array.reduce(a, function(a, c, d, e) {
        c = c.getVelocity();
        return isFinite(c) ? Math.min(a, c) : a
    }, mpl$lab$util$Util.POSITIVE_INFINITY)
}
;
mpl$lab$model$CollisionAdvance.prototype.myPrint = function(a, b) {
    if (mpl$lab$util$Util.DEBUG) {
        var c = goog.array.slice(arguments, 1);
        c.unshift("%c" + mpl$lab$util$Util.NF7(this.sim_.getTime()) + "%c " + a, "color:blue", "color:black");
        console.log.apply(console, c)
    }
}
;
mpl$lab$model$CollisionAdvance.prototype.print = function(a) {
    if (mpl$lab$util$Util.DEBUG && goog.array.contains(this.wayPoints_, a)) {
        var b = mpl$lab$model$CollisionAdvance.WayPoint;
        switch (a) {
        case b.START:
            this.myPrint("======== START advance;  timeStep=" + this.totalTimeStep_);
            break;
        case b.ADVANCE_SIM_START:
            this.myPrint("ADVANCE_SIM_START: step(" + mpl$lab$util$Util.NF7(this.currentStep_) + ") to " + mpl$lab$util$Util.NF7(this.sim_.getTime() + this.currentStep_) + " binarySearch=" + this.binarySearch_ + " nextEstimate=" + mpl$lab$util$Util.NF7(this.nextEstimate_) + " stuckCount=" + this.stuckCount_);
            break;
        case b.ADVANCE_SIM_FAIL:
            a = goog.array.count(this.collisions_, function(a) {
                return a.isColliding()
            });
            this.myPrint("ADVANCE_SIM_FAIL couldnt advance to " + mpl$lab$util$Util.NF7(this.sim_.getTime() + this.currentStep_) + " odeSolver.step found " + a + " colliding among " + this.collisions_.length + " collisions");
            break;
        case b.ADVANCE_SIM_COLLIDING:
            a = goog.array.count(this.collisions_, function(a) {
                return a.isColliding()
            });
            0 < a && this.myPrint("ADVANCE_SIM_COLLIDING advanced by " + mpl$lab$util$Util.NF7(this.currentStep_) + " but found " + a + " colliding binarySearch=" + this.binarySearch_);
            break;
        case b.ADVANCE_SIM_FINISH:
            this.myPrint("ADVANCE_SIM_FINISH " + this.stats_ + " binarySearch=" + this.binarySearch_);
            break;
        case b.POST_COLLISION:
            this.printCollisions("POST_COLLISION", !1);
            this.myPrint("POST_COLLISION " + this.stats_);
            break;
        case b.PRE_COLLISION:
            this.printCollisions("PRE_COLLISION", !1);
            this.myPrint("PRE_COLLISION " + this.stats_);
            break;
        case b.HANDLE_COLLISION_START:
            this.myPrint("HANDLE_COLLISION_START: numClose=" + this.numClose_);
            break;
        case b.COLLISIONS_TO_HANDLE:
            this.printCollisions("COLLISIONS_TO_HANDLE", !1);
            break;
        case b.HANDLE_REMOVE_DISTANT:
            goog.array.forEach(this.removedCollisions_, function(a) {
                mpl$lab$model$CollisionAdvance.printCollision(this.sim_.getTime(), "HANDLE_REMOVE_DISTANT:", a)
            }, this);
            break;
        case b.HANDLE_COLLISION_SUCCESS:
            this.myPrint("HANDLE_COLLISION_SUCCESS max impulse=" + mpl$lab$util$Util.NF5E(this.maxImpulse(this.collisions_)) + " min velocity=" + mpl$lab$util$Util.NF7E(this.minVelocity(this.collisions_)));
            this.printCollisions2("HANDLE_COLLISION_SUCCESS", .001);
            break;
        case b.HANDLE_COLLISION_FAIL:
            this.myPrint("%cHANDLE_COLLISION_FAIL%c  detectedTime_=" + mpl$lab$util$Util.NF7(this.detectedTime_) + " stuckCount=" + this.stuckCount_, "background:#f9c", "color:black");
            this.printCollisions("HANDLE_COLLISION_FAIL", !0);
            break;
        case b.ADVANCED_NO_BACKUP:
            this.myPrint("ADVANCED_NO_BACKUP nextEstimate=" + mpl$lab$util$Util.NF7(this.nextEstimate_) + " currentStep=" + mpl$lab$util$Util.NF7E(this.currentStep_) + " imminent=" + this.stats_.numImminent + " non-collisions=" + (this.collisions_.length - this.stats_.numImminent));
            break;
        case b.SMALL_IMPACTS_START:
            this.printCollisions("SMALL_IMPACTS_START", !0);
            break;
        case b.SMALL_IMPACTS_FINISH:
            this.printCollisions("SMALL_IMPACTS_FINISH", !0);
            break;
        case b.SMALL_IMPACTS:
            this.myPrint("SMALL_IMPACTS num collisions=" + this.collisions_.length + " max impulse=" + mpl$lab$util$Util.NF5E(this.maxImpulse(this.collisions_)) + " min velocity=" + mpl$lab$util$Util.NF7E(this.minVelocity(this.collisions_)));
            break;
        case b.BINARY_SEARCH_FAIL:
            this.myPrint("%cBINARY_SEARCH_FAIL%c turning off binary search, binarySteps_=" + this.binarySteps_, "background:#ffc", "color:black");
            break;
        case b.NEXT_STEP_ESTIMATE:
            this.myPrint("NEXT_STEP_ESTIMATE nextEstimate_=" + mpl$lab$util$Util.NF7(this.nextEstimate_) + " currentStep_=" + mpl$lab$util$Util.NF7E(this.currentStep_) + " numNeedsHandling=" + this.stats_.numNeedsHandling + " stuckCount=" + this.stuckCount_);
            break;
        case b.NEXT_STEP_BINARY:
            this.myPrint("%cNEXT_STEP_BINARY currentStep_=" + mpl$lab$util$Util.NF7E(this.currentStep_) + "%c detectedTime_=" + mpl$lab$util$Util.NF7(this.detectedTime_) + " binarySteps_=" + this.binarySteps_ + " numNeedsHandling=" + this.stats_.numNeedsHandling + " stuckCount_=" + this.stuckCount_, "background:#ffc", "color:black");
            break;
        case b.NEXT_STEP_FULL:
            this.myPrint("NEXT_STEP_FULL currentStep_=" + mpl$lab$util$Util.NF7E(this.currentStep_) + " totalTimeStep_=" + mpl$lab$util$Util.NF7(this.totalTimeStep_) + " timeAdvanced_=" + mpl$lab$util$Util.NF7(this.timeAdvanced_) + " stuckCount_=" + this.stuckCount_);
            break;
        case b.MAYBE_STUCK:
            this.myPrint("%cMAYBE_STUCK%c turning on binary search  stuckCount_=" + this.stuckCount_ + " nextEstimate_=" + mpl$lab$util$Util.NF7(this.nextEstimate_), "background:#f9c", "color:black");
            break;
        case b.ESTIMATE_IN_PAST:
            this.myPrint("%cESTIMATE_IN_PAST%c turning on binary search  nextEstimate_=" + mpl$lab$util$Util.NF7(this.nextEstimate_) + " needsHandling=" + this.stats_.numNeedsHandling, "background:#f9c", "color:black");
            break;
        case b.ESTIMATE_FAILED:
            this.myPrint("%cESTIMATE_FAILED%c turning on binary search  nextEstimate_=" + mpl$lab$util$Util.NF7(this.nextEstimate_) + " needsHandling=" + this.stats_.numNeedsHandling, "background:#f9c", "color:black");
            break;
        case b.NO_ESTIMATE:
            this.myPrint("%cNO_ESTIMATE%c turning on binary search  nextEstimate_=" + mpl$lab$util$Util.NF7(this.nextEstimate_) + " needsHandling=" + this.stats_.numNeedsHandling, "background:#f9c", "color:black");
            break;
        case b.SUMMARY:
            (0 < this.collisionCounter_ || 0 < this.backupCount_) && this.myPrint("**** SUMMARY handled " + this.collisionCounter_ + " collisions; " + this.backupCount_ + " backups; " + this.odeSteps_ + " steps; " + this.collisionTotals_);
            break;
        case b.FINISH:
            this.myPrint("=========  FINISH exiting advance  collisions=" + this.collisionTotals_.getCollisions() + " steps=" + this.collisionTotals_.getSteps());
            break;
        case b.STUCK:
            this.myPrint("STUCK collision was not resolved after " + this.stuckCount_ + " tries");
            this.printCollisions("STUCK", !0);
            console.log(this.sim_.getVarsList().printHistory());
            break;
        default:
            goog.asserts.fail()
...
;
mpl$lab$model$CollisionAdvance.printCollision = function(a, b, c) {
    var d = "color:black";
    0 > c.getVelocity() && (c.isColliding() ? d = "background:#fc6" : c.closeEnough(!0) && (d = "background:#cf3"));
    console.log("%c" + mpl$lab$util$Util.NF7(a) + "%c " + b + " %c" + c, "color:blue", "color:black", d)
}
;
mpl$lab$model$CollisionAdvance.prototype.printCollisions = function(a, b) {
    if (mpl$lab$util$Util.DEBUG) {
        var c = this.sim_.getTime();
        goog.array.forEach(this.collisions_, function(d, e) {
            (b || d.needsHandling() || !d.contact()) && mpl$lab$model$CollisionAdvance.printCollision(c, a + " [" + e + "]", d)
        }, this)
    }
}
;
mpl$lab$model$CollisionAdvance.prototype.printCollisions2 = function(a, b) {
    if (mpl$lab$util$Util.DEBUG) {
        var c = this.sim_.getTime();
        goog.array.forEach(this.collisions_, function(d, e) {
            Math.abs(d.getImpulse()) > b && mpl$lab$model$CollisionAdvance.printCollision(c, a + " [" + e + "]", d)
        }, this)
    }
}
;
mpl$lab$model$CollisionAdvance.prototype.printJointDistance = function() {
    var a = this.sim_.getTime();
    .025 <= a - this.printTime_ && (this.printTime_ = a,
    a = goog.array.filter(this.collisions_, function(a, c, d) {
        return a.bilateral()
    }),
    a = goog.array.map(a, function(a, c, d) {
        return a.getDistance()
    }),
    this.myPrint(mpl$lab$util$Util.array2string(a)))
}
;
mpl$lab$model$CollisionAdvance.prototype.removeDistant = function(a) {
    a = !1;
    for (var b = this.collisions_.length; 0 < b--; ) {
        var c = this.collisions_[b];
        c.isTouching() || (goog.array.removeAt(this.collisions_, b),
...
;
mpl$lab$model$CollisionAdvance.prototype.reset = function() {
    this.sim_.reset();
    this.collisionTotals_.reset();
    this.printTime_ = mpl$lab$util$Util.NEGATIVE_INFINITY
}
;
mpl$lab$model$CollisionAdvance.prototype.save = function() {
    this.sim_.saveInitialState()
}
;
mpl$lab$model$CollisionAdvance.prototype.setDebugLevel = function(a) {
    var b = mpl$lab$model$CollisionAdvance.WayPoint;
    switch (a) {
    case mpl$lab$model$CollisionAdvance.DebugLevel.NONE:
        this.wayPoints_ = [b.STUCK];
        goog.asserts.assert(1 == this.wayPoints_.length);
        break;
    case mpl$lab$model$CollisionAdvance.DebugLevel.LOW:
        this.wayPoints_ = [b.SUMMARY, b.STUCK];
        break;
    case mpl$lab$model$CollisionAdvance.DebugLevel.MEDIUM:
        this.wayPoints_ = [b.COLLISIONS_TO_HANDLE, b.HANDLE_REMOVE_DISTANT, b.HANDLE_COLLISION_SUCCESS, b.PRE_COLLISION, b.POST_COLLISION, b.STUCK];
        break;
    case mpl$lab$model$CollisionAdvance.DebugLevel.OPTIMAL:
        this.wayPoints_ = [b.ADVANCE_SIM_FAIL, b.ADVANCE_SIM_COLLIDING, b.POST_COLLISION, b.PRE_COLLISION, b.HANDLE_REMOVE_DISTANT, b.HANDLE_COLLISION_START, b.HANDLE_COLLISION_SUCCESS, b.HANDLE_COLLISION_FAIL, b.SMALL_IMPACTS, b.SMALL_IMPACTS_START, b.SMALL_IMPACTS_FINISH, b.BINARY_SEARCH_FAIL, b.NEXT_STEP_ESTIMATE, b.NEXT_STEP_BINARY, b.ESTIMATE_IN_PAST, b.ESTIMATE_FAILED, b.NO_ESTIMATE, b.MAYBE_STUCK, b.STUCK, b.SUMMARY];
        break;
    case mpl$lab$model$CollisionAdvance.DebugLevel.HIGH:
        this.wayPoints_ = [b.START, b.ADVANCED_NO_BACKUP, b.FINISH, b.ADVANCE_SIM_START, b.ADVANCE_SIM_FAIL, b.ADVANCE_SIM_COLLIDING, b.ADVANCE_SIM_FINISH, b.POST_COLLISION, b.PRE_COLLISION, b.HANDLE_REMOVE_DISTANT, b.HANDLE_COLLISION_START, b.HANDLE_COLLISION_SUCCESS, b.HANDLE_COLLISION_FAIL, b.SMALL_IMPACTS, b.SMALL_IMPACTS_START, b.SMALL_IMPACTS_FINISH, b.BINARY_SEARCH_FAIL, b.NEXT_STEP_ESTIMATE, b.NEXT_STEP_BINARY, b.NEXT_STEP_FULL, b.ESTIMATE_IN_PAST, b.ESTIMATE_FAILED, b.NO_ESTIMATE, b.MAYBE_STUCK, b.STUCK, b.SUMMARY];
        break;
    case mpl$lab$model$CollisionAdvance.DebugLevel.CUSTOM:
        this.wayPoints_ = [b.SMALL_IMPACTS];
        break;
    default:
        goog.asserts.fail()
    }
...
;
mpl$lab$model$CollisionAdvance.prototype.setDebugPaint = function(a) {
    mpl$lab$util$Util.DEBUG && (this.debugPaint_ = a)
}
;
mpl$lab$model$CollisionAdvance.prototype.setDiffEqSolver = function(a) {
    this.odeSolver_ = a
}
;
mpl$lab$model$CollisionAdvance.prototype.setJointSmallImpacts = function(a) {
    this.jointSmallImpacts_ = a
}
;
mpl$lab$model$CollisionAdvance.prototype.setTimeStep = function(a) {
    this.timeStep_ = a
}
;
mpl$lab$model$CollisionAdvance.prototype.setWayPoints = function(a) {
    this.wayPoints_ = goog.array.clone(a)
}
;
mpl$lab$model$CollisionAdvance.MAX_STUCK_COUNT = 30;
mpl$lab$model$CollisionAdvance.DebugLevel = {
    NONE: 0,
    LOW: 1,
    MEDIUM: 2,
    OPTIMAL: 3,
...
mpl$lab$model$CollisionAdvance.WayPoint = {
    START: 0,
...
var mpl$sims$springs$CollideBlocksApp = function(a) {
    mpl$lab$util$Util.setErrorHandler();
    var b = new mpl$lab$util$DoubleRect(-.5,-2,7.5,2)
      , c = new mpl$sims$springs$CollideBlocksSim
      , d = new mpl$lab$model$CollisionAdvance(c);
    mpl$sims$common$AbstractApp.call(this, a, b, c, d, c, c);
    this.protoBlock = (new mpl$lab$view$DisplayShape).setFillStyle("blue");
    this.protoWall = (new mpl$lab$view$DisplayShape).setFillStyle("lightGray");
    this.protoSpring = new mpl$lab$view$DisplaySpring;
    this.block1 = new mpl$lab$view$DisplayShape(this.simList.getPointMass("block1"),this.protoBlock);
    this.displayList.add(this.block1);
    this.block2 = new mpl$lab$view$DisplayShape(this.simList.getPointMass("block2"),this.protoBlock);
    this.displayList.add(this.block2);
    this.wallLeft = new mpl$lab$view$DisplayShape(this.simList.getPointMass("wallLeft"),this.protoWall);
    this.displayList.add(this.wallLeft);
    this.wallRight = new mpl$lab$view$DisplayShape(this.simList.getPointMass("wallRight"),this.protoWall);
    this.displayList.add(this.wallRight);
    this.spring1 = new mpl$lab$view$DisplaySpring(this.simList.getSpring("spring1"),this.protoSpring);
    this.displayList.add(this.spring1);
    this.spring2 = new mpl$lab$view$DisplaySpring(this.simList.getSpring("spring2"),this.protoSpring);
    this.displayList.add(this.spring2);
    this.addPlaybackControls();
    a = c.getParameterNumber(mpl$sims$springs$CollideBlocksSim.en.MASS_1);
    this.addControl(new mpl$lab$controls$NumericControl(a));
    a = c.getParameterNumber(mpl$sims$springs$CollideBlocksSim.en.MASS_2);
    this.addControl(new mpl$lab$controls$NumericControl(a));
    a = c.getParameterNumber(mpl$sims$springs$CollideBlocksSim.en.DAMPING);
    this.addControl(new mpl$lab$controls$NumericControl(a));
    a = c.getParameterNumber(mpl$sims$springs$CollideBlocksSim.en.STIFFNESS_1);
    this.addControl(new mpl$lab$controls$NumericControl(a));
    a = c.getParameterNumber(mpl$sims$springs$CollideBlocksSim.en.STIFFNESS_2);
    this.addControl(new mpl$lab$controls$NumericControl(a));
...
$jscomp.inherits(mpl$sims$springs$CollideBlocksApp, mpl$sims$common$AbstractApp);
mpl$sims$springs$CollideBlocksApp.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", block1: " + this.block1.toStringShort() + ", block2: " + this.block2.toStringShort() + ", wallLeft: " + this.wallLeft.toStringShort() + ", wallRight: " + this.wallRight.toStringShort() + ", spring1: " + this.spring1.toStringShort() + ", spring2: " + this.spring2.toStringShort() + mpl$sims$common$AbstractApp.prototype.toString.call(this)
}
;
mpl$sims$springs$CollideBlocksApp.prototype.getClassName = function() {
    return "CollideBlocksApp"
}
;
mpl$sims$springs$CollideBlocksApp.prototype.defineNames = function(a) {
    mpl$sims$common$AbstractApp.prototype.defineNames.call(this, a);
    this.terminal.addRegex("block1|block2|wallLeft|wallRight|spring1|spring2|protoBlock|protoWall|protoSpring", a + ".")
}
;
function module$contents$myphysicslab$sims$springs$CollideBlocksApp_makeCollideBlocksApp(a) {
    return new mpl$sims$springs$CollideBlocksApp(a)
}
goog.exportSymbol("makeCollideBlocksApp", module$contents$myphysicslab$sims$springs$CollideBlocksApp_makeCollideBlocksApp);
