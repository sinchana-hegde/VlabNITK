...
function drawrect(cen,p,q,s,t,blen,bwid,cornrad,context,bscolor,bfcolor,bswidth,omegatop)
{
	context.beginPath();
	...
	*/
	...
	context.lineTo(q.xcoord,q.ycoord);
	context.lineTo(t.xcoord,t.ycoord);
	context.lineTo(s.xcoord,s.ycoord);
